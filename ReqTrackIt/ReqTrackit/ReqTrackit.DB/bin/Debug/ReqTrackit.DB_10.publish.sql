...
GO
PRINT N'Dropping [dbo].[FK_nuget_request_tracker_request_tracker]...';


GO
ALTER TABLE [dbo].[nuget_request_tracker] DROP CONSTRAINT [FK_nuget_request_tracker_request_tracker];
